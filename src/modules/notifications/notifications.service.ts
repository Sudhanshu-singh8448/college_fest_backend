...
export class NotificationsService implements OnModuleInit {
  ...
  async removeDeviceToken(id: string, userId: string) {
    ...
    if (token.userId !== userId) throw new NotFoundException('Device token not found');
   ...
   */
  async sendFcmPush(userId: string, title: string, body: string, data?: Record<string, any>) {
