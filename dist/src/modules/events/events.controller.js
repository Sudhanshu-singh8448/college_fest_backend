...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Update an event (requires event:edit and organizer role unless global admin)' }),
    __param(0, (0, common_1.Param)('id')),
...
__decorate([
    ...
    (0, common_1.UseGuards)(permissions_guard_1.PermissionsGuard),
    (0, permissions_decorator_1.RequirePermissions)('event:edit'),
    (0, swagger_1.ApiOperation)({ summary: 'Update event status (requires event:edit and organizer role unless global admin)' }),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)()),
    __param(2, (0, current_user_decorator_1.CurrentUser)()),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, common_1.UseGuards)(permissions_guard_1.PermissionsGuard),
    (0, permissions_decorator_1.RequirePermissions)('event:edit'),
    (0, swagger_1.ApiOperation)({ summary: 'Add an organizer (requires event:edit and PRIMARY role unless global admin)' }),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)()),
    __param(2, (0, current_user_decorator_1.CurrentUser)()),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, common_1.UseGuards)(permissions_guard_1.PermissionsGuard),
    (0, permissions_decorator_1.RequirePermissions)('event:edit'),
    (0, swagger_1.ApiOperation)({ summary: 'Remove an organizer (requires event:edit and PRIMARY role unless global admin)' }),
    __param(0, (0, common_1.Param)('id')),
...
__decorate([
    ...
    (0, common_1.UseGuards)(permissions_guard_1.PermissionsGuard),
    (0, permissions_decorator_1.RequirePermissions)('event:edit'),
    (0, swagger_1.ApiOperation)({ summary: 'Get event statistics (requires event:edit and organizer role unless global admin)' }),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, current_user_decorator_1.CurrentUser)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Object]),
