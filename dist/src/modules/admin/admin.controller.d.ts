...
export declare class AdminController {
    ...
    getFinanceStats(user: any): Promise<{
        byStatus: {
            status: string;
            total: number;
            count: number;
    ...
    updateSettings(dto: UpdateSettingsDto, user: any): Promise<{
        settings: {
            [k: string]: string;
        };
        updatedAt: Date;
    }>;
    updateRegNumberFormat(dto: UpdateRegNumberFormatDto, user: any): Promise<{
        format: string;
        prefix: string;
        preview: string;
    }>;
